...
const ApplicationsPage = () => {
  ...
  const filteredApplications = applications.filter((app) => {
    ...
    return app.status?.toLowerCase().trim() === activeTab;
  });
        ...
        {loading ? (
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-yellow-700 text-sm">
                              Your application is being reviewed by the shelter.
                              You should receive a response within 2-3 business
                              days.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-green-700 text-sm">
                              Congratulations! The shelter has approved your
                              application. They will contact you soon to
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-red-700 text-sm">
                              We're sorry, your application was not approved at
                              this time. Please contact the shelter for more
                              information.
                            </p>
                          </div>
                        </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">
              You haven't submitted any adoption applications yet. Start by
              finding a pet you'd like to adopt!
            </p>
